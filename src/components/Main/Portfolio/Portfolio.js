    ...
    return (
        <section className="portfolio">
            ...
            <div className="portfolio__list">
                <a href="https://nail-khusainov.github.io/Hotel-Booking/" className="portfolio__element">
                    <h2 className="portfolio__element-title">Статичный сайт</h2>
                    <img className="portfolio__element-arrow" src={arrow} alt="arrow-sign" />
                </a>
                <a href="https://nail-khusainov.github.io/russian-travel/" className="portfolio__element">
                    <h2 className="portfolio__element-title">Адаптивный сайт</h2>
                    <img className="portfolio__element-arrow" src={arrow} alt="arrow-sign" />
                </a>
                <a href="https://nail-khusainov.github.io/mesto/" className="portfolio__element">
